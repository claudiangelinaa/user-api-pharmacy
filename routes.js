...
router.get('/getRacikTransaction/:id', transactionController.selectAllRacikTransaction)
router.post("/UploadBuktiBayar/:transactionId", transactionController.uploadBuktiBayar);
